...
namespace AdventureWorksDemo.Data.Tests.reqnroll.Extensions
{
    internal static class StringExtensions
    {
        internal static string InterpretValue(this string value)
        {
            if (!value.Contains("{{"))
            {
                return value;
        ...
        internal static string FullNameReadable(this Type t)
        {
